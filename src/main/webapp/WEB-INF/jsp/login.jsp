...
<HEAD>
    ...
    <STYLE>
        ...
        * {
        ...
        .u_logo {
            background: url("../resources/static/img/username.png") no-repeat;
            padding: 10px 10px;
            position: absolute;
            top: 43px;
            left: 40px;
        ...
        .p_logo {
            background: url("../resources/static/img/password.png") no-repeat;
            padding: 10px 10px;
            position: absolute;
            top: 12px;
            left: 40px;
        ...
        .tou {
            background: url("../resources/static/img/tou.png") no-repeat;
            width: 97px;
            height: 92px;
            position: absolute;
            top: -87px;
        ...
        .left_hand {
            background: url("../resources/static/img/left_hand.png") no-repeat;
            width: 32px;
            height: 37px;
            position: absolute;
            top: -38px;
        ...
        .right_hand {
            background: url("../resources/static/img/right_hand.png") no-repeat;
            width: 32px;
            height: 37px;
            position: absolute;
            top: -38px;
        ...
        .initial_left_hand {
            background: url("../resources/static/img/hand.png") no-repeat;
            width: 30px;
            height: 20px;
            position: absolute;
            top: -12px;
        ...
        .left_handing {
            background: url("../resources/static/img/left-handing.png") no-repeat;
            width: 30px;
            height: 20px;
            position: absolute;
            top: -24px;
        ...
        .right_handinging {
            background: url("../resources/static/img/right_handing.png") no-repeat;
            width: 30px;
            height: 20px;
            position: absolute;
            top: -21px;
...
<form id="addMessage">
    ...
    <DIV
        ...
        <P style="padding: 30px 0px 10px; position: relative;">
            ...
            <INPUT class="ipt" type="text" placeholder="请输入用户名或邮箱" id="number" name="number">
        </P>
        ...
        <DIV style="margin: 5px 1px 1px 1px;">
            <INPUT type="radio" name="identity" value="teacher">学生
            <INPUT type="radio" name="identity" value="stu">社长
            <INPUT type="radio" name="identity" value="teacher">管理员
        </DIV>
        <DIV
            ...
            <P style="margin: 0px 35px 20px 45px;">
                ...
                <a type="submit"
                   ...
                   value="注册" data-toggle="modal" data-target="#myModal" onclick="register()"></a>

					<input type="submit"
                           style="background: rgb(0, 142, 173); padding: 7px 10px; border-radius: 4px; border: 1px solid rgb(26, 117, 152); border-image: none; color: rgb(255, 255, 255); font-weight: bold;"
                           value="登陆" onclick="login()"></input> </SPAN>
            </P>
        </DIV>
    </DIV>
